...
public class JCLQType3Adapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public JCLQType3Adapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(TYPE_LEVEL_0, R.layout.fragment_jclq_item_header);
        addItemType(TYPE_LEVEL_1, R.layout.fragment_jclq_item_content_3);
    }
