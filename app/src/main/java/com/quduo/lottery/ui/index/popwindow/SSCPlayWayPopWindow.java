...
public class SSCPlayWayPopWindow extends PopupWindow {
    private Context context;

    private CustomeGridView gridView;
    private SSCPlayWayAdapter adapter;
    private OnSSCPlayWayItemClickListener onSSCPlayWayItemClickListener;

    public SSCPlayWayPopWindow(Context context) {
        super(context);
    ...
    public void setOnSSCPlayWayItemClickListener(OnSSCPlayWayItemClickListener onSSCPlayWayItemClickListener) {
        this.onSSCPlayWayItemClickListener = onSSCPlayWayItemClickListener;
    }
    ...
    private void initView(View rootView) {
        String[] sscPlayWays = context.getResources().getStringArray(R.array.ssc_play_way);
        ...
        list.add(new PlayWayInfo(sscPlayWays[4], true, false));
        list.add(new PlayWayInfo(sscPlayWays[5], true, false));
        ...
        final int defaultPayWayPosition = SPUtils.getInstance().getInt(AppConfig.KEY_SSC_DEFAULT_PLAY_WAY_POSITION, 0);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                SPUtils.getInstance().put(AppConfig.KEY_SSC_DEFAULT_PLAY_WAY_POSITION, i);
                dismiss();
                if (onSSCPlayWayItemClickListener != null) {
                    onSSCPlayWayItemClickListener.OnSSCPlayWayItemClick(i);
                }
            }
        });
    }
    ...
    public interface OnSSCPlayWayItemClickListener {
        void OnSSCPlayWayItemClick(int position);
    }
