...
public class SSQWinCodeAdapter extends BaseAdapter {
    private Context context;
    private List<String> list;
    private LayoutInflater inflater;

    public SSQWinCodeAdapter(Context context, List<String> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_ssq_wincode_item, viewGroup, false);
