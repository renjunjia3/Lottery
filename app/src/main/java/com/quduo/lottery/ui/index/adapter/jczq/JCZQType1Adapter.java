...
public class JCZQType1Adapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public JCZQType1Adapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(TYPE_LEVEL_0, R.layout.fragment_jczq_item_header);
        addItemType(TYPE_LEVEL_1, R.layout.fragment_jczq_item_content_1);
    }
