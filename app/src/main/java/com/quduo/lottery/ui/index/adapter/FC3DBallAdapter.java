...
public class FC3DBallAdapter extends BaseAdapter {
    private Context context;
    private List<SSQBallInfo> list;
    private LayoutInflater inflater;

    public FC3DBallAdapter(Context context, List<SSQBallInfo> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_fc3d_item, viewGroup, false);
