...
import com.quduo.lottery.ui.index.presenter.JCLQConfirmBetPresenter;
...
public class JCLQConfirmBetFragment extends BaseBackMvpFragment<IJCLQConfirmBetView, JCLQConfirmBetPresenter> implements IJCLQConfirmBetView {
    ...
    public static JCLQConfirmBetFragment newInstance(int lotteryType, int playWayType) {
        Bundle args = new Bundle();
        args.putInt(ARG_LOTTERY_TYPE, lotteryType);
        args.putInt(ARG_PLAY_WAY_TYPE, playWayType);
        JCLQConfirmBetFragment fragment = new JCLQConfirmBetFragment();
    ...
    @Override
    public JCLQConfirmBetPresenter initPresenter() {
        return new JCLQConfirmBetPresenter(this);
    }
