...
public class JCLQType5Adapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public JCLQType5Adapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(TYPE_LEVEL_0, R.layout.fragment_jclq_item_header);
        addItemType(TYPE_LEVEL_1, R.layout.fragment_jclq_item_content_5);
    }
