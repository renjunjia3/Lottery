...
public class JCLQPlayWayPopWindow extends PopupWindow {
    private Context context;

    private CustomeGridView gridView;
    private SSCPlayWayAdapter adapter;
    private OnJCLQPlayWayItemClickListener onJCLQPlayWayItemClickListener;

    public JCLQPlayWayPopWindow(Context context) {
        super(context);
    ...
    public void setOnJCZQPlayWayItemClickListener(OnJCLQPlayWayItemClickListener onJCLQPlayWayItemClickListener) {
        this.onJCLQPlayWayItemClickListener = onJCLQPlayWayItemClickListener;
    }
    ...
    private void initView(View rootView) {
        String[] sscPlayWays = context.getResources().getStringArray(R.array.jclq_play_way);
        ...
        final int defaultPayWayPosition = SPUtils.getInstance().getInt(AppConfig.KEY_JCLQ_DEFAULT_PLAY_WAY_POSITION, 0);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                SPUtils.getInstance().put(AppConfig.KEY_JCLQ_DEFAULT_PLAY_WAY_POSITION, i);
                dismiss();
                if (onJCLQPlayWayItemClickListener != null) {
                    onJCLQPlayWayItemClickListener.OnJCLQPlayWayItemClick(i);
                }
            }
        });
    }
    ...
    public interface OnJCLQPlayWayItemClickListener {
        void OnJCLQPlayWayItemClick(int position);
    }
