...
public class JCLQType2Adapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public JCLQType2Adapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(TYPE_LEVEL_0, R.layout.fragment_jclq_item_header);
        addItemType(TYPE_LEVEL_1, R.layout.fragment_jclq_item_content_2);
    }
