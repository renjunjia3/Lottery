...
public class JCZQMatchResultAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public JCZQMatchResultAdapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(TYPE_LEVEL_0, R.layout.fragment_jczq_match_result_header);
        addItemType(TYPE_LEVEL_1, R.layout.fragment_jczq_match_result_content);
    }
