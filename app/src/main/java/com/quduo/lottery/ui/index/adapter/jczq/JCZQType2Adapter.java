...
public class JCZQType2Adapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public JCZQType2Adapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(TYPE_LEVEL_0, R.layout.fragment_jczq_item_header);
        addItemType(TYPE_LEVEL_1, R.layout.fragment_jczq_item_content_2);
    }
