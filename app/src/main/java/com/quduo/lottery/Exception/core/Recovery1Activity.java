package com.quduo.lottery.Exception.core;
...
import com.quduo.lottery.Exception.tools.RecoverySharedPrefsUtil;
import com.quduo.lottery.Exception.tools.RecoveryUtil;
 ...
 */
public final class Recovery1Activity extends AppCompatActivity {
    ...
    private void setupEvent() {
        ...
        mRestartClearBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog dialog = new AlertDialog.Builder(Recovery1Activity.this)
        ...
        mCrashTipsTv.setText(getString(R.string.recovery_crash_tips_msg));
