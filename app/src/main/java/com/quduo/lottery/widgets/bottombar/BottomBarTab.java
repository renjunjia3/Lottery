package com.quduo.lottery.widgets.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon_d, int icon_s, CharSequence title) {
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.main_tab_unselect_color));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.main_tab_select_color));
        } else {
            mIcon.setImageResource(resIcon_d);
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.main_tab_unselect_color));
        }
    }
